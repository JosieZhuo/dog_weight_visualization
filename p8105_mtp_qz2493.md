...
new variable called “weight”. I grouped the dogs by name and obtained
the number of observations as well as mean and standard deviations of
each dog.
...
dog’s weight is affected by both internal(physical health) and external
factors(location, other dogs).
