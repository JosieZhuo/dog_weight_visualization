...
### Problem 1
The raw data records the weight of three dogs-Raisin, Simone, Gagne from 2018 to 2022, together with a standard object. The goal of this report includes tidying and restructuring the data set into a more readable way; describing the statistical features of the dataset; and visualizing the the distribution and trend of weights for each dog.
```{r}
total_df = 
