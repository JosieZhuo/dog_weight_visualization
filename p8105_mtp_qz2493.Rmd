...
I applied pivot_longer to incorperated three dogs and standard object into a new variable named "dog", and their weights are stored in another variable called "weight", after which I grouped the dogs by name and obtained the number of observations as well as mean and standard deviations by dog categories.
```{r}
weight_data %>%
...
I generated a boxplot to display the distribution of weights for each dog. We can conclude that Raisin weighs most, with average weight around 18 lbs, while Gagne and Simone weight less and similarly, with average weight around 10 lbs. Besides, Simon's weight has greatest variance. 
